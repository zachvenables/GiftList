...
export default function Home() {
  ...
  const bagDash = (gift) => {
    return (<div className={styles.bagIcon} onClick={e => onclick(gift)}>
      <svg xmlns="http://www.w3.org/2000/svg" width={dimensions} height={dimensions} fill="red" className="bi bi-bag-dash" viewBox="0 0 16 16">
  ...
  const bagCheck = (gift) => {
    return (<div className={styles.bagIcon} onClick={e => onclick(gift)}>
      <svg xmlns="http://www.w3.org/2000/svg" width={dimensions} height={dimensions} fill="green" className="bi bi-bag-check-fill" viewBox="0 0 16 16">
